<div class="py-4 space-y-4 ">
    <div class="flex justify-between">
        <div>
            <x-buttons.primary wire:click="create" ><x-icons.plus />Nouvelle catégorie produit</x-buttons.primary>
        </div>
    </div>
        {{-- subcategories table --}}
                    ...
                    <x-tables.row >
                        <x-tables.cell colspan="8">
                            <div class="flex justify-center items-center">
                                <span class="py-8 text-gray-400 font-medium text-xl">Aucune catégorie produit trouvée</span>
                            </div>
                        </x-tables.cell>
                    </x-tables.row>
                @endforelse
