<div>
    <div class="py-4 space-y-4 ">
        ...
        <div class="flex-col space-y-4">
            <x-tables.table>
                <x-slot name="head">
                    <x-tables.heading sortable wire:click="sortBy('order_id')" :direction="$sortField === 'order_id' ? $sortDirection : null">No BL</x-tables.heading>
                    <x-tables.heading sortable wire:click="sortBy('listing_id')" :direction="$sortField === 'listing_id' ? $sortDirection : null">Ingrédient</x-tables.heading>
                    <x-tables.heading sortable wire:click="sortBy('batch_no')" :direction="$sortField === 'batch_no' ? $sortDirection : null">No Lot</x-tables.heading>
                    <x-tables.heading sortable wire:click="sortBy('price')" :direction="$sortField === 'price' ? $sortDirection : null">Prix /kg</x-tables.heading>
                    <x-tables.heading sortable wire:click="sortBy('qty')" :direction="$sortField === 'qty' ? $sortDirection : null">Qty</x-tables.heading>
                ...
                <x-slot name="body">
                    ...
                    <x-tables.row wire:loading.class.delay="opacity-50">
                        <x-tables.cell>{{$supply->order_id}}</x-tables.cell>
                        ...
                        <x-tables.row >
                            <x-tables.cell colspan="8">
                                <div class="flex justify-center items-center">
                                    <span class="py-8 text-gray-400 font-medium text-xl">Aucun ingrédient trouvé</span>
                                </div>
                            </x-tables.cell>
                        </x-tables.row>
                    @endforelse
