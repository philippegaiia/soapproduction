...
>
    ...
    <input
        ...
        x-ref="input"
        x-bind:value="value"
        class="py-2 pl-2 rounded-none rounded-r-md flex-1 block w-full border border-gray-300 focus:outline-none focus:border-indigo-300 focus:ring focus:ring-inset focus:ring-indigo-300 focus:ring-opacity-50 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
    />
</div>
